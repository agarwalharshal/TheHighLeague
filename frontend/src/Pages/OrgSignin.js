		...
		if (!user && !org) {
			return (
				...
				>
					...
					>
						<div className="container-fluid justify-content-center position-relative">
							<div
								...
								onClick={Home}
								style={{ borderRadius: "30px", fontSize: "1.5rem", left: "3%" }}
							>
								Home
							</div>
					...
					<div
						className="how position-relative d-md-flex flex-md-row flex-md-wrap justify-content-md-around my-5 py-5"
					...
					>
						...
						>
							<div
								className="inner position-relative d-flex d-flex-column justify-content-center pt-3 pb-3 align-items-center d-flex"
								style={{
							...
							>
								<div
									className="id position-relative px-3"
									style={{ width: "60%" }}
								>
									<p
										className="id"
